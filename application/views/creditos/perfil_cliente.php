            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Correo</b> <a class="pull-right">info@suzukiatrum.com</a>
                </li>
                <li class="list-group-item">
                  <b>Telefono</b> <a class="pull-right">(953) 114 3026</a>
                </li>
                <li class="list-group-item">
                  <b>Celular</b> <a class="pull-right">(953) 114 3026</a>
                </li>
              </ul>

              <a href="#" class="btn btn-primary pull-right"><b>Nuevo Credito</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Creditos</a></li>
